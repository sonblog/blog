...
tags:
- Machine Learning
description: "Có thể bạn đã nghe đến cụm từ Machine Learning (hay Data Mining, Big Data, Data Science,...) nhưng bạn chưa bao giờ hiểu ý nghĩa thực sự của chúng là gì"
---
